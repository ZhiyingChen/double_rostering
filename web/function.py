...
from web.language_dict import APP_LANG, PROJECT_DOC_LANG, EXECUTE_ALGORITHM_LANG
...
def get_language_dict(page: str = "app"):
    ...
    if page == "app":
        ...
        return lang, EXECUTE_ALGORITHM_LANG[lang]
    elif page == "doc":
        return lang, PROJECT_DOC_LANG[lang]
    else:

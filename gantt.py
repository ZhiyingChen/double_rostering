from src.Rostering.singleRoster.config import Sign
from src.Rostering.singleRoster.config import paramHeader as ph
...
if __name__ == '__main__':
    ...
    out_df = pd.read_csv('output/result.csv', index_col=0, dtype=object)
    ...
    for car in cars:
        ...
        for hour, activity in dic.items():
            ...
            n_bay_start.append(int(car.split('_')[0]))
            n_bay_text.append(car)
